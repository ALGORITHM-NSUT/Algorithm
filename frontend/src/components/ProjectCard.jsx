...
const ProjectCard = function ProjectCard({ project, isOngoing, refreshProjects }) {
  ...
  return (
    <div>
      <AddProject refreshProjects={refreshProjects} showadd={false} edit={editProject} setEditState={setEditProject} project={project} />
      <div
        className="relative bg-gray-800/30 p-4 h-[680px] rounded-lg shadow-lg cursor-pointer transition-all duration-300 backdrop-blur-xl"
